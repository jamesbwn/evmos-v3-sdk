...
var Trade = /*#__PURE__*/ (function() {
  ...
  function Trade(_ref) {
    ...
    !currencyEquals(inputAmount.currency, route.input)
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'INPUT_CURRENCY_MATCH')
        : invariant(false)
      : void 0
    !currencyEquals(outputAmount.currency, route.output)
      ? process.env.NODE_ENV !== 'production'
              ...
              while (1) {
                switch ((_context4.prev = _context4.next)) {
                  ...
                  case 12:
                    ...
                    if (
                      !(
                        !currencyEquals(pool.token0, amountIn.currency) &&
                        !currencyEquals(pool.token1, amountIn.currency)
                      )
                    ) {
                      _context4.next = 16
                      break
              ...
              while (1) {
                switch ((_context5.prev = _context5.next)) {
                  ...
                  case 12:
                    ...
                    if (
                      !(
                        !currencyEquals(pool.token0, amountOut.currency) &&
                        !currencyEquals(pool.token1, amountOut.currency)
                      )
                    ) {
                      _context5.next = 16
                      break
