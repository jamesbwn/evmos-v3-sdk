...
var Route = /*#__PURE__*/ (function() {
  function Route(pools, input, output) {
    ...
    !pools[pools.length - 1].involvesToken(sdkCore.wrappedCurrency(output, chainId))
                ...
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    ...
                    !(currencyAmountIn === nextAmountIn || currentPools.length > 0)
                      ...
                      : void 0
                    chainId = nextAmountIn.currency.isToken
                  ...
                  case 12:
                    ...
                    if (
                      !(
                        !sdkCore.currencyEquals(pool.token0, amountIn.currency) &&
                        !sdkCore.currencyEquals(pool.token1, amountIn.currency)
                      )
                    ) {
                      _context4.next = 16
                      break
                ...
                switch ((_context5.prev = _context5.next)) {
                  case 0:
                    ...
                    !(currencyAmountOut === nextAmountOut || currentPools.length > 0)
                      ? invariant(false, 'INVALID_RECURSION')
                      : void 0
                    chainId = nextAmountOut.currency.isToken
                  ...
                  case 12:
                    ...
                    if (
                      !(
                        !sdkCore.currencyEquals(pool.token0, amountOut.currency) &&
                        !sdkCore.currencyEquals(pool.token1, amountOut.currency)
                      )
                    ) {
                      _context5.next = 16
                      break
  ...
  _createClass(Trade, [
    ...
    },
    {
      ...
      get: function get() {
        ...
        return (_this$_priceImpact = this._priceImpact) != null
          ? _this$_priceImpact
          : (this._priceImpact = sdkCore.computePriceImpact(this.route.midPrice, this.inputAmount, this.outputAmount))
      }
    }
  ])
...
var NonfungiblePositionManager = /*#__PURE__*/ (function(_SelfPermit) {
  ...
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, options) {
    ...
    if (options.useEther) {
      ...
      !(weth && (position.pool.token0.equals(weth) || position.pool.token1.equals(weth)))
  ...
  NonfungiblePositionManager.encodeCollect = function encodeCollect(options) {
    ...
    if (involvesETH) {
      var ethAmount = options.expectedCurrencyOwed0.currency.isEther
        ? options.expectedCurrencyOwed0.quotient
        : options.expectedCurrencyOwed1.quotient
      var token = options.expectedCurrencyOwed0.currency.isEther
        ? options.expectedCurrencyOwed1.currency
        : options.expectedCurrencyOwed0.currency
      var tokenAmount = options.expectedCurrencyOwed0.currency.isEther
        ? options.expectedCurrencyOwed1.quotient
        : options.expectedCurrencyOwed0.quotient
      calldatas.push(
        ...
        _extends(
          {
            ...
            expectedCurrencyOwed0: expectedCurrencyOwed0.add(
              expectedCurrencyOwed0.currency.isEther
                ? sdkCore.CurrencyAmount.ether(amount0Min)
            ...
            expectedCurrencyOwed1: expectedCurrencyOwed1.add(
              expectedCurrencyOwed1.currency.isEther
                ? sdkCore.CurrencyAmount.ether(amount1Min)
